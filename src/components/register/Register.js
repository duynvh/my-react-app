...
class Register extends Component {
  ...
  componentDidMount() {
    if (!isEmpty(this.props.match.params.sponsor)) {
      //   this.setState({
      //     sponsor: this.props.match.params.sponsor
      //   });
      this.setState({
        sponsor: this.props.match.params.sponsor
      });
      console.log(this.props.match.params.sponsor);
    }
    if (this.captchaDemo) {
        ...
        <Paper className={classes.paper}>
          ...
          <form onSubmit={this.onSubmit} className={classes.form}>
            ...
            <div className={classes.boxes}>
              ...
              <Link to="/login">
                <span className={classes.text}>Sign me in!</span>
              </Link>
            </div>
          </form>
        </Paper>
...
const mapStateToProps = (state, ownProps) => {
  //   if (ownProps.match.params.sponsor) {
  //   }
  //   console.log(state);
  return {
    auth: state.auth
